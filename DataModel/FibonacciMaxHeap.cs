...
public class FibonacciMaxHeap<T, TKey> where TKey : IComparable<TKey> {
    ...
    public FibonacciMaxHeap(TKey maxKeyValue) {
    ...
    public FibonacciHeapNode<T, TKey> RemoveMin() {
        FibonacciHeapNode<T, TKey> minNode = _maxNode;
        ...
        if (minNode != null) {
            ...
            while (numKids > 0) {
                ...
                oldMinChild.Left = _maxNode;
                oldMinChild.Right = _maxNode.Right;
                _maxNode.Right = oldMinChild;
